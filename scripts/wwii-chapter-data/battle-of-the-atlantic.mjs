export const battleOfTheAtlanticBlocks = [
	{
		type: 'paragraph',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'fahren-box-cover.jpg', alt: 'Box cover for Wir Fahren gegen Engeland', caption: 'Wir Fahren gegen Engeland' },
			{ src: 'fahren-full-board.jpg', alt: 'Full board for Wir Fahren gegen Engeland', caption: 'Wir Fahren board' },
			{
				src: 'fahren-backs-royal-oak-courageous-hood-ark-royal-repulse-malaya.jpg',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'cbc-full-map.jpg', alt: 'Full map for Carrying the Tools to Britain', caption: 'Carrying the Tools to Britain' },
			{ src: 'cbc-heartland.jpg', alt: 'Heartland detail from Carrying the Tools to Britain', caption: 'Canadian heartland' },
			{ src: 'cbc-value-for-money.jpg', alt: 'What We Get for our Money from Carrying the Tools to Britain', caption: 'What We Get for our Money' }
		]
	},
	{
		type: 'paragraph',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'sea-raider-box-top.jpg', alt: 'Box top for Sea Raider', caption: 'Sea Raider' },
			{ src: 'almost-home.jpg', alt: 'Almost home on the Sea Raider board', caption: 'Almost home' }
		]
	},
	{
		type: 'paragraph',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'sub-chaser-box-cover.jpg', alt: 'Box cover for Submarine Chaser', caption: 'Submarine Chaser' },
			{ src: 'submarine-chaser-board.jpg', alt: 'Board for Submarine Chaser', caption: 'Submarine Chaser board' }
		]
	},
	{
		type: 'paragraph',
	...
	{
		type: 'figure',
		src: 'klar-zum-gefecht-box-cover.jpg',
	...
	{
		type: 'figure',
		src: 'wir-fliegen-gegen-engeland.jpg',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'contraband-full-board.jpg', alt: 'Full board for Contraband Control', caption: 'Contraband Control' },
			{
				src: 'contraband-copyright-sinking-detail.jpg',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'blockade-box-cover.jpg', alt: 'Box cover for Blockade', caption: 'Blockade' },
			{ src: 'blockade-board.jpg', alt: 'Board for Blockade', caption: 'Blockade board' }
		]
	},
	{
		type: 'paragraph',
