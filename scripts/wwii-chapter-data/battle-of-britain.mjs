export const battleOfBritainBlocks = [
	{
		type: 'paragraph',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'air-sea-rescue-launch-ecu.jpg', alt: 'Air-sea rescue launch', caption: 'Air-sea rescue launch' },
			{ src: 'air-sea-rescue-board.jpg', alt: 'Board for Game of Air-Sea Rescue', caption: 'Game of Air-Sea Rescue' },
			{
				src: 'air-sea-rescue-counters-die-and-box.jpg',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'board.jpg', alt: 'Board for Black-Out', caption: 'Black-Out board' },
			{ src: 'people.jpg', alt: 'People cards from Black-Out', caption: 'People cards' },
			{ src: 'fire.jpg', alt: 'Fire equipment cards from Black-Out', caption: 'Fire equipment' },
			{ src: 'crossings.jpg', alt: 'Street crossings on the Black-Out board', caption: 'Street crossings' },
			{ src: 'vehicles.jpg', alt: 'Vehicle playing pieces from Black-Out', caption: 'Vehicles' }
		]
	},
	{
		type: 'paragraph',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'aerial-attack-box-cover.jpg', alt: 'Box cover for Aerial Attack', caption: 'Aerial Attack' },
			{ src: 'aerial-attack-board.jpg', alt: 'Board for Aerial Attack', caption: 'Aerial Attack board' },
			{
				src: 'aerial-attack-ground-rules-spaces.jpg',
	...
	{
		type: 'figure',
		src: 'bomber-uber-england-board.jpg',
	...
	},
	{
		type: 'figure-stack',
		figures: [
			{ src: 'fahren-und-fliegen.jpg', alt: 'Board for Wir fahren und fliegen gegen England', caption: 'Wir fahren und fliegen gegen England' },
			{
				src: 'fahren-und-fliegen-space-30-description.jpg',
				alt: 'Space 30 description from Wir fahren und fliegen gegen England',
				caption: 'Space 30'
			},
			{
				src: 'fahren-und-fliegen-pieces-ecu.jpg',
